...
\begin{center}
    \begin{tabularx}{\textwidth}{ |X|X| }
     ...
     %Sharding & \enquote{eine Art horizontaler Partitionierung, bei der große Datenbanken in kleinere Komponenten aufgeteilt werden, die schneller und leichter zu verwalten sind} \cite{MS1} \\ %bugged
