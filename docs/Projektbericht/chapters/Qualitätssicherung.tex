...
Die Automatisierung von Testfällen maximiert die Effizienz, wenn Testfälle in den Kontinuierliche-Integration(Continuous integration) Workflows einbezieht werden. %Der neue Code kann automatisch getestet werden, zum Beispiel jedes Mal, wenn ein neues Push-Request erstellt wird.
\\\\
