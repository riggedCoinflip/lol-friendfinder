...
Nachdem die Projektanforderungen definiert waren, wurden die JavaScript Framework Angular, Vue und React, als Option für die Entwicklung der Benutzeroberfläche bewertet.
